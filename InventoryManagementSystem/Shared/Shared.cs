...
namespace InventoryManagementSystem.Shared
{
    public static class Shared
    {
        ...
        public static void SeedFakeProducts()
        {
            ...
            var products = GenerateFakeProducts(2500);
            ...
            var fakeProductGenerator = new Faker<Product>()
              ...
              //  .RuleFor(p => p.RealPrice, f => f.Random.Number(1, 100))
               // .RuleFor(p => p.Price, f => f.Random.Number(100, 10000))
                ...
                .RuleFor(p => p.CompanyId, f => f.Random.Number(1, 5)) // Update with your actual CompanyId generation logic
                .RuleFor(p => p.CarTypeId, f => f.Random.Number(1, 5)) // Update with your actual CarTypeId generation logic
                .RuleFor(p => p.CountryId, f => f.Random.Number(1, 5)) // Update with your actual CountryId generation logic
                .RuleFor(p => p.SetTypeId, f => f.Random.Number(1, 2));// Update with your actual SetTypeId generation logic
